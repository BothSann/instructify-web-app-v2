                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900">
                                            Samsung Refrigerator Model RT29K5030S8
                                        </div>
                                        <div class="max-w-xs text-sm text-gray-500 truncate">
                                            User manual for Samsung double-door refrigerator
                                        </div>
                                    </div>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">Home Appliances</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                                <div class="flex space-x-3">
                                    <a href="#" class="text-indigo-600 hover:text-indigo-900">View</a>
                                    <span class="text-gray-400 cursor-not-allowed">Download</span>
                                </div>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                                <div class="flex space-x-3">
                                    <a href="#" class="text-indigo-600 hover:text-indigo-900">View</a>
                                    <a href="#" class="text-indigo-600 hover:text-indigo-900">Edit & Resubmit</a>
                                </div>
                            </td>
                        </tr>
