                ...
                <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="max-w-md mt-1 text-xs text-gray-500 truncate">
                                        Complete user manual for LG front load washing machine
                                        with TurboWash technology.
                                    </div>
                                </div>
                            </div>
                        </td>
                  ...
                  <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                    ...
                    <tr>
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="max-w-md mt-1 text-xs text-gray-500 truncate">
                                        User manual for Sony Bravia 4K Ultra HD LED Smart
                                        Google TV.
                                    </div>
                                </div>
                            </div>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span
                                class="inline-flex px-2 py-1 text-xs font-semibold leading-5 text-purple-800 bg-purple-100 rounded-full">
                                Electronics
                            </span>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                    ...
                    <tr class="bg-yellow-50">
                        <td class="px-6 py-4">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4">
                                    ...
                                    <div class="max-w-md mt-1 text-xs text-gray-500 truncate">
                                        Complete user manual with troubleshooting guide for
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            ...
                            <div class="text-xs text-gray-500">sarah.j@example.com</div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <span
                                class="inline-flex px-2 py-1 text-xs font-semibold leading-5 text-blue-800 bg-blue-100 rounded-full">
                    ...
                    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                        <div>
                            <p class="text-sm text-gray-700">
                                ...
                                <span class="font-medium">248</span> manuals
                            </p>
                        </div>
                        <div>
